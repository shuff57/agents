...
manim -ql -s script.py Scene1  # preview still (last frame)
...
media/images/script/480p15/Scene1_Intro.png  (from -s flag)

# With --media_dir=/custom/path set at render time:
# /custom/path/videos/script/1080p60/Scene1.mp4
```
