...
- **Persistent memory across sessions** — remembers who you are, your preferences, environment details, and lessons learned. Pluggable memory backends (built-in holographic, Honcho, and more) let you choose how memory works.
...
Plus: AI Gateway, MiniMax CN, GitHub Copilot ACP.
